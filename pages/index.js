    ...
    <Layout home metaTags={metaTags}>
      <section>
        ...
        <Typography variant={'body2'} paragraph={true}>
          ...
          Every feedback and/or request is greatly appreciated, prefer twitter for a faster answer
          if it doesn't concern a specific project, otherwise you can use github.<br/>
